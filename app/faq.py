...
def ingest_faq_data(path):
    if collection_name not in [c.name for c in chroma_client.list_collections()]:
        ...
        print(f"FAQ Data successfully ingested into Chroma DB: {collection_name}")
    else:
        print(f"Collection {collection_name} already present in Chroma DB")
...
def generate_asnwer(query,context):
...
if __name__ == "__main__":
    ...
    query = "what's kind of payment options are accepted ?"
